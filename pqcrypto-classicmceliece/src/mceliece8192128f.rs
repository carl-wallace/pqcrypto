...
//! // use pqcrypto::kem::mceliece8192128f::*;
//! let (pk, sk) = keypair();
...
simple_struct!(PublicKey, ffi::PQCLEAN_MCELIECE8192128F_VEC_CRYPTO_PUBLICKEYBYTES);
simple_struct!(SecretKey, ffi::PQCLEAN_MCELIECE8192128F_VEC_CRYPTO_SECRETKEYBYTES);
simple_struct!(
    Ciphertext,
