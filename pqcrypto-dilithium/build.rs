...
fn main() {
    ...
    build_clean!("dilithium2");
    if target_arch == "x86_64" && avx2_enabled && !is_windows {
        build_avx2!("dilithium2");
    }
    if target_arch == "aarch64" && neon_enabled {
        build_aarch64!("dilithium2");
    }
    build_clean!("dilithium3");
    if target_arch == "x86_64" && avx2_enabled && !is_windows {
        build_avx2!("dilithium3");
    }
    if target_arch == "aarch64" && neon_enabled {
        build_aarch64!("dilithium3");
    }
    build_clean!("dilithium5");
    if target_arch == "x86_64" && avx2_enabled && !is_windows {
        build_avx2!("dilithium5");
    }
    if target_arch == "aarch64" && neon_enabled {
