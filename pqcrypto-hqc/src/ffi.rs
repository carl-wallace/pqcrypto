...
extern "C" {
        ...
        pub fn PQCLEAN_HQCRMRS128_CLEAN_crypto_kem_enc(ct: *mut u8, ss: *mut u8, pk: *const u8) -> c_int;
...
extern "C" {
        ...
        pub fn PQCLEAN_HQCRMRS192_CLEAN_crypto_kem_enc(ct: *mut u8, ss: *mut u8, pk: *const u8) -> c_int;
...
extern "C" {
        ...
        pub fn PQCLEAN_HQCRMRS256_CLEAN_crypto_kem_enc(ct: *mut u8, ss: *mut u8, pk: *const u8) -> c_int;
